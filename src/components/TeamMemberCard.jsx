    ...
    <>
      ...
      <div className="bg-white/90 dark:bg-black/80 rounded-xl border border-gray-200 dark:border-gray-700/80 overflow-hidden backdrop-blur-sm flex flex-col h-full">
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <div className="flex items-center gap-2 text-blue-400 font-medium text-sm mb-2 flex-wrap">
            {role && <span>{role}</span>}
            {role && location && <span className="text-gray-300 dark:text-gray-600">|</span>}
            {location && (
