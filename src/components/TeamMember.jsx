function TeamMember({ image, name, phone, email, linkedin, background, skills, experience }) {
  return (
    <div className="mb-16 slide-in-right">
        ...
        <div className="w-full md:w-3/4">
          ...
          <div className="space-y-3 text-gray-600 dark:text-gray-300">
            <div className="flex items-center gap-3">
              ...
              <a href={`tel:${phone.replace(/\s/g, '')}`} className="text-lg hover:text-gray-900 dark:hover:text-white transition">
                {phone}
              </a>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a href={`mailto:${email}`} className="text-lg hover:text-gray-900 dark:hover:text-white transition">
                {email}
              </a>
            </div>
            {linkedin && (
              <div className="flex items-center gap-3">
                ...
                <a href={linkedin} target="_blank" rel="noopener noreferrer" className="text-lg hover:text-gray-900 dark:hover:text-white transition">
                  {linkedin}
                </a>
              </div>
            )}
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Background</h3>
