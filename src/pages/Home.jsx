              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-start">
                    <svg className="w-5 h-5 mr-3 mt-1 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+40738846868" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition">
                        +40 738 846 868
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:radu.popescu@model-tree.net" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition">
                        radu.popescu@model-tree.net
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 mr-3 mt-1 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 24 24">
